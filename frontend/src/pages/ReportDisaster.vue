            ...
            <div class="card-body">
                ...
                <div class="flex flex-wrap justify-between gap-4 mb-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <input type="text" id="disasterLatitude" v-model="currentLat" readonly
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <input type="text" id="disasterLongitude" v-model="currentLng" readonly
                            class="input input-bordered w-full" />
                    </div>
                </div>
                ...
                <div class="flex-auto mb-4">
                    ...
                    <input type="text" id="disasterAddress" v-model="currentAddress" class="input input-bordered w-full" />
                </div>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <select id="disasterType" v-model="selectedDisasterType" class="input input-bordered w-full">
